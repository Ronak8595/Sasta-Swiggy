      ...
      {items.map((item) => (
        ...
        >
          ...
          <div className="px-4 pt-4 ">
            <span className="font-bold text-xl line-clamp-1 flex">
              {" "}
              <span className="">
                {item?.card?.info.isVeg ? (
                  <img className="h-8 mr-2" src={veg}></img>
                ) : (
                  <img className="h-8 mr-2" src={nonveg}></img>
                )}
              </span>{" "}
              <span className="line-clamp-1">{item?.card?.info.name}</span>{" "}
            </span>

            <p className="text-base my-3 line-clamp-3 min-h-[72]">
