    ...
    <>
      <div className="bg-black h-48 pt-2 flex justify-between text-white border-t-2 border-gray-100">
        <div className="flex flex-col">
          <div className="mx-12 my-2 text-2xl text-orange-500 font-bold">
            About us{" "}
          </div>
          ...
          <div className="flex ml-8 mt-1">
            <button className="mx-1">
              <a href="https://github.com/Ronak8595" target="_blank">
                <img src={Github} alt="" className="rounded-full w-14" />
              </a>
            </button>
            <button className="hover:shadow-white rounded-full  ">
              <a
                href="https://www.linkedin.com/in/ronak-ramuka-9a8595229//"
                target="_blank"
              >
                <img src={Linkedin} alt="" className="h-11 -ml-1" />
              </a>
            </button>
        ...
        <div className="hidden sm:block mt-11 mr-11">
          ...
          />
          <button
            className="bg-white text-black py-2 px-6 rounded-lg  ml-2 hover:bg-orange-500"
            onClick={() => setEmail("")}
          >
            {" "}
            Submit
      ...
      <div className="hidden md:flex bg-zinc-900 h-15  text-zinc-500 justify-center max-w-full">
        <div className="flex  ">
          <div className="flex mr-60 border-b-2 border-b-slate-600 hover:text-white hover:border-b-white">
            <p className="mt-[5]"> Sasta-Swiggy </p>
