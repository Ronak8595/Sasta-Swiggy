        ...
        <div className="flex flex-col items-center pb-72 pt-20 px-[120] ">
          <div className="flex">
            <h1 className="text-8xl mb-8 text-orange-500 pr-12">
              Welcome to <h1 className="text-orange-950 pt-3">Sasta Swiggy</h1>
            </h1>
          ...
          <p className="text-slate-800 text-xl mt-14 font-semibold shadow-lg shadow-gray-300 px-2 py-4 bg-gray-100">
            At Sasta-Swiggy, we are driven by a relentless passion for
      ...
      <div className="h-[550]">
        ...
        <div class="p-6 mt-10 mx-16 rounded-md shadow-[0px_18px_40px_4px_rgba(0,0,0,0.56)] flex">
          ...
          <p className="text-2xl mt-11 text-slate-800 mx-14 pl-4">
            Founded in 2022, "Sasta-Swiggy" started as a small team of food
      ...
      <div className="h-full pb-16">
        ...
        <div class="p-6 mt-10 mx-16 rounded-md shadow-[0px_18px_40px_4px_rgba(0,0,0,0.56)] flex">
          ...
          <div>
            ...
            <p className="text-2xl mt-9 text-slate-800 mx-14 ">
              At "Sasta-Swiggy", we take pleasure in spoiling our users with
