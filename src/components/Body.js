...
export default function Body() {
  ...
  async function getRestaurants() {
    const data = await fetch(
      "https://carefood-cors.vercel.app/api/proxy/swiggy/dapi/restaurants/list/v5?lat=28.7080797&lng=77.1617883&is-seo-homepage-enabled=true&page_type=DESKTOP_WEB_LISTING"
    );
