...
export const menu_url =
  "https://food-delivery-cors.vercel.app/api/proxy/swiggy/dapi/menu/pl?page-type=REGULAR_MENU&complete-menu=true&lat=28.7080797&lng=77.1617883&restaurantId=";

export const FAQdata = [
  {
    que: "1. How does Sasta-Swiggy work?",
    ans: "Sasta-Swiggy is a user-friendly food ordering platform that connects you with a variety of local restaurants. Simply browse through the menu options, make your selection, place your order, and enjoy delicious meals delivered straight to your doorstep.",
  },
  {
    que: "2. What types of cuisines are available on Sasta-Swiggy",
    ans: "Sasta-Swiggy offers a diverse range of cuisines to cater to every taste bud. From comforting local favorites to exotic global flavors, you'll find a wide variety of options to choose from.",
  },
  {
  ...
  {
    que: "9. Is Sasta-Swiggy available in my area?",
